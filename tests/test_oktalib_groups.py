...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(lambda okta: okta.search_groups_by_name('name'), [], id='search_groups_by_name'),
        pytest.param(lambda okta: okta.search_groups_by_query('name'), [], id='search_groups_by_query'),
    ],
)
