...
## [5.0.0](https://github.com/schubergphilis/oktalib/compare/v4.0.0...v5.0.0) (2026-09-15)
...
* add application metadata VCR cassette for SAML integration ([b6908eb](https://github.com/schubergphilis/oktalib/commit/b6908ebff838beb1450f70e7cf9a389ea2f120e6))
...
* add methods to retrieve application by sign-on mode and SAML metadata ([15a3322](https://github.com/schubergphilis/oktalib/commit/15a3322ba89245340b9ecf9d3e496d9c705f9d9a))
...
* add Pylint step to quality assurance workflow for improved code quality ([7dda0d7](https://github.com/schubergphilis/oktalib/commit/7dda0d7d7c6fbf33e73d1940249ce645fe7b8690))
* add SAML metadata handling and Single Sign-On service model ([dd0f6e9](https://github.com/schubergphilis/oktalib/commit/dd0f6e93a392447a60de13ceaaafcf9083871ab5))
...
* enhance header removal in Betamax configuration for case-insensitivity & adding missing base_url that wasn't getting redacted ([dcecf74](https://github.com/schubergphilis/oktalib/commit/dcecf74e19041c4a8d598fdaf2474f0df61bbc46))
...
* suppress deprecation warning for datetime.utcnow in betamax adapter ([a72c615](https://github.com/schubergphilis/oktalib/commit/a72c6150b9bcbf8ceb83bfaba1f3eb68bcc47138))
...
* update id property to ensure it always returns a string ([838f48e](https://github.com/schubergphilis/oktalib/commit/838f48ec834d93fd1cce059c26e24b5f494dff43))
...
* update testing instructions to use pytest instead of unittest and include pylint. Plus notes about how to write tests ([12fe36b](https://github.com/schubergphilis/oktalib/commit/12fe36bf177ed9090eb95e63bfcb850d1a396fd6))
